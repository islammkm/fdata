 ...
 * Use the {@link Supplier#newInstance} factory method to
...
public class Supplier extends Fragment {
     ...
     * @return A new instance of fragment Supplier.
     */
    // TODO: Rename and change types and number of parameters
    public static Supplier newInstance(String param1, String param2) {
        Supplier fragment = new Supplier();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textcode = view.findViewById(R.id.supplieraffich);
        ImageView copierCode = view.findViewById(R.id.suppliercopie);
        Button generbtn = view.findViewById(R.id.suppliergen);
